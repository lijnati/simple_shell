...
/**
 * get_environ - Returns a copy of the string array containing the environment variables
 * @info: A pointer to a structure containing potential arguments
 * Return: A copy of the string array containing the environment variables
 */
